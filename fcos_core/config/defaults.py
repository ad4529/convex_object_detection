...
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
_C.MODEL.FCOS.NUM_CLASSES = 4  # the number of classes including background
_C.MODEL.FCOS.FPN_STRIDES = [8, 16, 32, 64, 128]
_C.MODEL.FCOS.PRIOR_PROB = 0.01
_C.MODEL.FCOS.INFERENCE_TH = 0.05
_C.MODEL.FCOS.NMS_TH = 0.3
_C.MODEL.FCOS.NMS_TOPK = 15
_C.MODEL.FCOS.PRE_NMS_TOP_N = 1000
_C.MODEL.FCOS.EVAL_IOU_TH = 0.3
...
_C.MODEL.FCOS.CENTER_SAMPLING_RADIUS = 1.0
...
_C.SOLVER.MOMENTUM = 0.01

_C.SOLVER.WEIGHT_DECAY = 0.001
_C.SOLVER.WEIGHT_DECAY_BIAS = 0
_C.SOLVER.WEIGHT_DECAY_CLS_TOWER = 0.001

_C.SOLVER.GAMMA = 0.1
_C.SOLVER.STEPS = (50000,)

_C.SOLVER.WARMUP_FACTOR = 1 / 5.0
